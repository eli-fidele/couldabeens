...
Existing literature has established a decline in labor share in the MLB since the 2003 CBA (Bradbury, 2019).
...
For a given year $Y$, we first compute the mean rookie's WAR, call it $\mu_Y$. Then, we construct the corresponding classifier for "couldabeen" status $C$ of a given retired player $p$ (from the year $Y$) to be as follows:
\[
C(p) = \begin{cases}
