 ...
 **Linear Model:** After classifying all retiring players, we divide the number of "couldabeen" retirees by the total number of retirements for each year ('prop'). We then run a linear model fitting `Year ~ prop`.
